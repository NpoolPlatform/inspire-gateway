...
require (
	...
	github.com/NpoolPlatform/good-middleware v0.0.0-20230826040727-70fb11824a13
	...
	github.com/NpoolPlatform/order-middleware v0.0.0-20230825084855-a8ce957e9800
